      ...
      <div className="p-1.5 ">
        <div className="flex items-center gap-2 mb-2.5 mx-2">
          <div className="flex-1 flex items-center gap-2">
            <CodeXmlIcon className="h-3.5 w-3.5 text-black dark:hidden" />
            <CodeXmlIcon className="h-3.5 w-3.5 hidden dark:block" />
          </div>
          <p className="text-primary text-xs tracking-tighter">Upgrade now!</p>
        </div>
